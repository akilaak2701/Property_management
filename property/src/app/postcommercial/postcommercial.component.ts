...
@Component({
  selector: 'app-postcommercial',
  templateUrl: './postcommercial.component.html',
  styleUrls: ['./postcommercial.component.css']
})
export class PostcommercialComponent implements OnInit {
 ...
 this.api.add("propertydb", commercial).subscribe(
  (res) => {
