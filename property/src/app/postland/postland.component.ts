...
@Component({
  selector: 'app-postland',
  templateUrl: './postland.component.html',
  styleUrls: ['./postland.component.css']
})
export class PostlandComponent implements OnInit {
 ...
 this.api.add("propertydb", land).subscribe(
  (res) => {
